...
export const homeCards = [
  {
    title: 'About Me',
    description: 'Background, interests, goals, and the mindset behind the site.',
    href: '#/about',
  },
  {
    title: 'Projects',
    description: 'Python programs, old HTML exercises, and quick links.',
    href: '#/projects',
  },
  {
    title: 'Browser Demos',
    description: 'React versions of the old browser-safe Python recreations.',
    href: '#/browser-projects',
  },
  {
    title: 'Contact',
    description: 'Fast ways to reach me through GitHub or email.',
    href: '#/contact',
  },
]
